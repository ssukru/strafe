...
final class FocusRestorer {
    ...
    /// Owner pids of on-screen, normal-layer windows on the current Space,
    /// front to back. Tiny or fully transparent windows (helper windows some
    /// apps keep open) are skipped so they cannot claim focus.
